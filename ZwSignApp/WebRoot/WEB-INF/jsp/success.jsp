...
<body>
    ...
    <div class="login-form">
        ...
        <div class="head-info" style="font-size:1rem;line-height:50px; margin-bottom:30px"> 恭喜，您的APK上传成功，已完成签名!</div>
        
        
        <div class="signin">
            <!-- <input type="submit" class="btn btn-default" value="上传 & 签名"> -->
            <!-- <a class="submit" >下载已签名APK</a> -->
            <a href="../app/download" ><input type="submit" value="下载已签名APK"></a>
        </div>
    </div>
</body>
