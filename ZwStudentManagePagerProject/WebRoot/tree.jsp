...
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"students/Students_list.jsp"},
	{ level:1, name:"XXX管理"},
	{ level:2, name:"XXX列表", ico:"images/icon_default.gif",link:"students/Students_list.jsp"},
	{ level:1, name:"XXX管理"},
	{ level:2, name:"XXX管理", ico:"images/icon_default.gif",link:"students/Students_list.jsp"},
	{ level:2, name:"XXX管理", ico:"images/icon_default.gif",link:"students/Students_list.jsp"},
	{ level:1, name:"系统邮件", ico:"images/icon_default.gif",link:"students/Students_list.jsp"},
	{ level:1, name:"网络文件", ico:"images/icon_default.gif",link:"students/Students_list.jsp"}
];
</script>
<style>
* {
