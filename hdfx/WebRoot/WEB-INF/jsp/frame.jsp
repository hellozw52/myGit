...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false"
		...
		<div class="site_title">话单分析系统</div>
	...
	<div data-options="region:'west',split:true,title:'导航菜单'"
		...
		<div class="easyui-accordion sider"
			...
			<!--//左侧菜单导航-->
			<!--waiceng-->
			<div title="话单操作" data-options="iconCls:'icon-mini-add'"
				style="padding:10px;">
				<ul class="easyui-tree" data-options="animate:true">
					<li data-options="state:'closed'"><span>话单查询</span>
						<ul>
							<li>
								<a href="javascript:viod(0);" cmshref="../bill/goToBillTab" type="member_perinfo" rel="">话单列表</a>
							</li>
						</ul>
					</li>
				</ul>
	...
	<div data-options="region:'south',border:false"
		...
		<div id="footer">
			Copyright &copy; 2019 by hellozw.<br> All Rights Reserved<br>
		</div>
	</div>
	<!--//主体内容部分-->
